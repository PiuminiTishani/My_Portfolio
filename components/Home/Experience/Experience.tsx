          ...
          <div className="relative w-full max-w-5xl h-[400px]">
            {achievementsData.map((achievement, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`bg-[#0f0f2f]/85 backdrop-blur-lg rounded-3xl p-8 md:p-12 h-full shadow-2xl border border-[#80e0ff20] flex flex-col md:flex-row gap-8 items-center hover:shadow-[0_0_40px_rgba(128,224,255,0.3)] hover:border-[#80e0ff40] transition-all duration-300 ${
                      isTop ? "hover:scale-[1.02]" : ""
                    }`}
                  >
                    {/* Left side - Image */}
                    <div className="w-full md:w-2/5 h-64 md:h-full relative rounded-2xl overflow-hidden shrink-0">
                      <Image
                    ...
                    <div className="w-full md:w-3/5 flex flex-col justify-center">
                      ...
                      <p className="text-[#80e0ff] text-sm font-semibold mb-4">
                        {achievement.duration}
                      </p>
                      <p className="text-gray-300 text-sm md:text-base mb-6 leading-relaxed line-clamp-4">
                      ...
                      {isTop && (
                        <button 
                          ...
                          className="px-6 py-2 bg-[#00035bb4] hover:bg-[#2e1190b8] rounded-full border-2 text-white font-semibold transition-all duration-300 self-start"
                        >
                          View Positions
                        </button>
                      )}
